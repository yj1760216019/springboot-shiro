package com.carlinx.shiro.base.result;
...
public class JsonResult<T> implements Serializable {
    ...
    public JsonResult(boolean success,String msg,T data,String code){
        this.success = success;
        this.msg = msg;
        this.data = data;
        this.code = code;
    ...
    public static <T> JsonResult<T> success(String msg,T t,String code){
        return new JsonResult<>(true,msg,t,code);
    }

    public static <T> JsonResult fail(String msg,String code){
        return new JsonResult(false,msg,null,code);
    }
